...
def ask_ai(data_context, user_question):
    # We try these in order. One of them WILL work.
    model_names = [
    ...
    for name in model_names:
        try:
            ...
            full_prompt = f"You are a health analyst. Context: {data_context}. Question: {user_question}"
    ...
    return f"AI Error: Could not connect to any models. Details: {error_log}"
