...
# --- CLOUD CONFIG ---
# This code gets your keys safely from the Cloud settings
...
# Detect the URL of the app automatically
# Note: You will need to update the Fitbit Dev portal with this URL later
...
if st.session_state.access_token:
    ...
    # Sync Data
    with st.spinner("Analyzing your Fitbit data..."):
    ...
    if prompt := st.chat_input("Ask about your trends..."):
        ...
        with st.chat_message("assistant"):
            response = model.generate_content(f"You are a health AI. Context: {all_data_context}. Question: {prompt}")
